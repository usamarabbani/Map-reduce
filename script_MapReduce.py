...
students_path = os.path.join(directory_path, 'students_run')
...
final_concept_csv = csv.writer(open(os.path.join(directory_path,
'final_Concepts.txt'), 'w'), delimiter='\t')
final_urlpages_csv = csv.writer(open(os.path.join(directory_path,
'final_UrlPages.txt'), 'w'), delimiter='\t')
final_mctu_csv = csv.writer(open(os.path.join(directory_path,
